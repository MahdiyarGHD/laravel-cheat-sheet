    ...
    return <>
        <header className="flex text-white/70 justify-between w-full bg-white/[3%] rounded-[23px] shadow-md backdrop-blur-3xl h-14 rounded-3xl border border-white/5" dir="rtl">
                <div>
                    ...
                    <a href="https://github.com/MahdiyarGHD/laravel-cheat-sheet/" target="_blank" className='group float-right mr-4 mt-[14px] w-20 h-[25px] text-[11px] text-center rounded-3xl text-white/70 bg-white/[3%] rounded-[23px] shadow-md backdrop-blur-3xl border-white/5 border hover:bg-white/[10%] cursor-pointer'>
